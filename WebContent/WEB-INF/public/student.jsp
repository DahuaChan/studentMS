...
<body class="">
	...
	<div class="content">
		...
		<ul class="breadcrumb">
			...
			<li><a href="users.html">学生</a> <span class="divider">/</span></li>
		...
		<div class="container-fluid">
			<div class="row-fluid">
				...
				<div class="btn-toolbar">
					<button class="btn btn-primary" onclick="checkStudent()">
				...
				<div class="well">
					...
					<div id="myTabContent" class="tab-content">
						<div class="tab-pane active in" id="home">
							<form action="add?type=student" method="post" id="tab">
								<label>学号</label>
								<input type="text" value=""
									class="input-xlarge" id="stu_id" name="stu_id"> <label>密码</label> <input
									type="password" value="" class="input-xlarge" id="stu_password" name="stu_password"> <label>姓名</label>
								<input type="text" value="" class="input-xlarge" id="stu_name" name="stu_name"> <label>学院</label>
								<input type="text" value="" class="input-xlarge" id="sub_name" name="sub_name"> <label>专业</label>
								<input type="text" value="" class="input-xlarge" id="maj_name" name="maj_name">
